...
var donation = confirm("Woukd you like to donate $10 to St. Jude Medical Research?");
...
if(donation && donation5) {
    ...
    alert("Your total price of food bought + $15 Donation to St. Jude Medical Research & UNICEF = $" + totalPrice); //printing out total to the user using alert box.
